# 🚀 GocqlX [![GoDoc](https://pkg.go.dev/badge/github.com/croatiangrn/gocqlx/v2.svg)](https://pkg.go.dev/github.com/croatiangrn/gocqlx/v2) [![Go Report Card](https://goreportcard.com/badge/github.com/scylladb/gocqlx)](https://goreportcard.com/report/github.com/scylladb/gocqlx) [![Build Status](https://travis-ci.org/scylladb/gocqlx.svg?branch=master)](https://travis-ci.org/scylladb/gocqlx)
...
```bash
    go get -u github.com/croatiangrn/gocqlx/v2
```
...
```bash
go get -u "github.com/croatiangrn/gocqlx/v2/cmd/schemagen"
```
...
import "github.com/croatiangrn/gocqlx/v2/table"
...
* [gocql project](https://github.com/croatiangrn/gocql), licensed under the BSD license
